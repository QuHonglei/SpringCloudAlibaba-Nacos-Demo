package com.itheibai.user.generator;
...
public class MybatisPlusGenerator {
    public static void main(String[] args) {
        ...
        //获取项目路径
        String projectPath = fuPath + "/user-service";
        System.out.println(projectPath);
        // 需要构建一个 代码自动生成器 对象
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/cloud-user?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8",
                        "root",
                        "123456")
                ...
                .packageConfig(builder -> {
                    builder.parent("com.itheibai.user") // 父包名
                            ...
                            .pathInfo(Collections.singletonMap(OutputFile.mapper,projectPath + "/src/main/java/com/itheibai/user/sys/dao")) // 配置mapper生成路径
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("tb_user") // 增加表匹配
